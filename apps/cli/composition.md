...
The dsh-base bundle patch shared by the web, headless, sdk, sdk-net, and acp profiles; their mode bundles and user layers patch over it, while sdk-minimal owns a separate standalone tree.
